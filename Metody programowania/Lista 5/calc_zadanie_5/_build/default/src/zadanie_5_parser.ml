...
module MenhirBasics = struct
  ...
  type token = 
    ...
    | LPAREN
    | FLOAT of (
# 1 "src/zadanie_5_parser.mly"
       (float)
# 20 "src/zadanie_5_parser.ml"
  )
    | EOF
    | DIV
...
and ('s, 'r) _menhir_cell1_expr = 
  | MenhirCell1_expr of 's * ('s, 'r) _menhir_state * (Zadanie_5_ast.expr)

and ('s, 'r) _menhir_cell1_LPAREN = 
  | MenhirCell1_LPAREN of 's * ('s, 'r) _menhir_state

and _menhir_box_main = 
  | MenhirBox_main of (Zadanie_5_ast.expr) [@@unboxed]

let _menhir_action_1 =
  fun f ->
    (
# 22 "src/zadanie_5_parser.mly"
                ( Float f )
# 75 "src/zadanie_5_parser.ml"
     : (Zadanie_5_ast.expr))

let _menhir_action_2 =
  fun e1 e2 ->
    (
# 23 "src/zadanie_5_parser.mly"
                                 ( Binop(Add, e1, e2) )
# 83 "src/zadanie_5_parser.ml"
     : (Zadanie_5_ast.expr))

let _menhir_action_3 =
  fun e1 e2 ->
    (
# 24 "src/zadanie_5_parser.mly"
                                  ( Binop(Sub, e1, e2) )
# 91 "src/zadanie_5_parser.ml"
     : (Zadanie_5_ast.expr))

let _menhir_action_4 =
  fun e1 e2 ->
    (
# 25 "src/zadanie_5_parser.mly"
                                ( Binop(Div, e1, e2) )
# 99 "src/zadanie_5_parser.ml"
     : (Zadanie_5_ast.expr))

let _menhir_action_5 =
  fun e1 e2 ->
    (
# 26 "src/zadanie_5_parser.mly"
                                  ( Binop(Mult, e1, e2) )
# 107 "src/zadanie_5_parser.ml"
     : (Zadanie_5_ast.expr))

let _menhir_action_6 =
  fun e ->
    (
# 27 "src/zadanie_5_parser.mly"
                               ( e )
# 115 "src/zadanie_5_parser.ml"
     : (Zadanie_5_ast.expr))

let _menhir_action_7 =
  fun e ->
    (
# 18 "src/zadanie_5_parser.mly"
                    ( e )
# 123 "src/zadanie_5_parser.ml"
     : (Zadanie_5_ast.expr))
