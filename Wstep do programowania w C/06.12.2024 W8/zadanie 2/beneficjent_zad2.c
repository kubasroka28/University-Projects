...
//--------------Licznik zajetych indeksow--------------

unsigned int licznik_zajetych_indeksow=0;
...
struct Osoba*   nowa_osoba(char* imie, uint8_t wiek)
{
    ...
    //przypisywanie indeksu
    stworzona_osoba->indeks = licznik_zajetych_indeksow;
    licznik_zajetych_indeksow++;
...
{
    int roznica_zasl_i_szelm = (os1->zaslugi - os1->szelmostwa) - (os2->zaslugi - os2->szelmostwa);
    int roznica_wieku = os1->wiek - os2->wiek;
